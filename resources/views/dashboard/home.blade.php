...
<?php
$stok1 = \DB::select("select * from barang where stock < 10 AND stock > 0 AND harga > 0");
$stok2 = \DB::select("select * from barang where stock = 0 AND harga > 0");
?>
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            ...
            @foreach($stok1 as $st1)
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Segera Restok Barang</strong> {{ $st1 -> nama}} tersisa {{ $st1 -> stock}}
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            @endforeach

            @foreach($stok2 as $st2)
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Segera Restok Barang</strong> {{ $st2 -> nama}} habis
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            @endforeach
